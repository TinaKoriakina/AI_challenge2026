...
/** Той самий гліф, що `assets/icons/fluent/emoji-2048.svg` (SharePoint / Office 2048 grid). */
export function Emoji220Regular(props: React.SVGProps<SVGSVGElement>): React.ReactElement {
  return (
    <svg
